...
def main() -> int:
    ...
    receipt = {
        ...
        "document_001_unresolved_proposition_paths": closure.get("still_unresolved_citation_paths", 0),
        "CITATION_PATH_CLOSURE": closure.get("CITATION_PATH_CLOSURE", "UNKNOWN"),
        "FULL_MANUSCRIPT_SEMANTIC_CLOSURE": closure.get("FULL_MANUSCRIPT_SEMANTIC_CLOSURE", "NOT_ESTABLISHED"),
