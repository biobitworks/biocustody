...
## 🎬 Submission Videos (Byron in the corner talking!)

Since your connected Google account has no public YouTube channel created yet (returning `youtubeSignupRequired` from the YouTube Data API), we generated both videos locally, composed them with your portrait in the lower-right corner, and pushed them directly to this repository for instant viewing:

- 📺 **2-Minute Pitch Video (Team intro + elevator pitch):** [Download/Watch Raw MP4](https://raw.githubusercontent.com/biobitworks/biocustody/main/session/biocustody_pitch_2min.mp4)
- 📺 **1-Minute Playcast Video (Interactive prototype demo):** [Download/Watch Raw MP4](https://raw.githubusercontent.com/biobitworks/biocustody/main/session/biocustody_playcast_1min.mp4)
...
- **AlphaTensor, Phenaki, AlphaProteo, USM, DolphinGemma:** Surfaced as display-only model/research artifacts in the Folding screen model list to contextualize the scientific lineage. Not actively executed.
