...
4. Shifted state: ALK ORF profile measured away from reference.
5. Ranking: R = 1 - D(candidate, reference) / D(perturbation, reference).
6. Evidence and custody: PF-06463922 -> ALK -> not_verified_in_tiny_mvp plus FCO receipt and tamper failure.
